...
public class AlertsActivity extends AppCompatActivity {
    ...
    public static void setANDROIDID(String ANDROIDID) {
        AlertsActivity.ANDROIDID = ANDROIDID;
    }
    ...
    com.kfxlabs.smartsociety.api.GetAlerts mAPIService = Api.getAlertsAPIService(AlertsActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(AlertsActivity.this);

        setANDROIDID(Settings.Secure.getString(getApplicationContext().getContentResolver(),
                Settings.Secure.ANDROID_ID));

        getAlertsAPIService = Api.getAlertsAPIService(AlertsActivity.this);
    ...
    public void AlertGet() {
        ...
        mAPIService.savePost().enqueue(new Callback<Alerts>() {
            ...
            public void onResponse(Call<Alerts> call, Response<Alerts> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    SharedPrefManager manager = SharedPrefManager.getInstance(AlertsActivity.this);
                    ...
                    for(int alertIndex=0; alertIndex < totalDgs; alertIndex++) {
                        ...
                        recyclerView.setLayoutManager(new LinearLayoutManager(AlertsActivity.this));
                        adapter = new Alerts_Adapter(AlertsActivity.this,alertValueDetailsList);
            ...
            public void onFailure(Call<Alerts> call, Throwable t) {
                if (t instanceof SocketTimeoutException) {
                    ...
                    Toast.makeText(AlertsActivity.this, "Unable to submit post to API.Connection timed out", Toast.LENGTH_LONG).show();
                }else{
