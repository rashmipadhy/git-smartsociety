...
public class AlertActivity extends AppCompatActivity {
    ...
    public static void setANDROIDID(String ANDROIDID) {
        AlertActivity.ANDROIDID = ANDROIDID;
    }
    ...
    public TextView a_tankdetails;
    GetAlerts getAlertsAPIService;
    com.kfxlabs.smartsociety.api.GetAlerts mAPIService = Api.getAlertsAPIService(AlertActivity.this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.recycler_view_b);
        a_tvdate = findViewById(R.id.a_tv_date1);
        a_tankdetails = findViewById(R.id.a_tv_tankdetails);
        a_tvtime = findViewById(R.id.a_tv_time1);

        Toolbar toolbar =findViewById(R.id.toolbar1);
        setSupportActionBar(toolbar);
        loadingDialog = new LoadingDialog(AlertActivity.this);

        setANDROIDID(Settings.Secure.getString(getApplicationContext().getContentResolver(),
                Settings.Secure.ANDROID_ID));

        getAlertsAPIService = Api.getAlertsAPIService(AlertActivity.this);
    ...
    public void AlertGet() {
        ...
        mAPIService.savePost().enqueue(new Callback<com.kfxlabs.smartsociety.module.Alerts>() {
            ...
            public void onResponse(Call<Alerts> call, Response<Alerts> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    Log.i("POST1", "post submitted to API." + response.body());

                    SharedPrefManager manager = SharedPrefManager.getInstance(AlertActivity.this);
                    manager.clearExistingDGValues();

                    Alerts alertlist = response.body();
                    List<Alerts_Details> alertValueDetailsList = new ArrayList<>();
                    Log.i("POST1", "post submitted to API." + alertValueDetailsList);
                    ...
                    for(int alertIndex=0; alertIndex < totalDgs; alertIndex++) {
                        ...
                        adapter = new Alerts_Adapter(AlertActivity.this,alertValueDetailsList);
            ...
            public void onFailure(Call<Alerts> call, Throwable t) {
                if (t instanceof SocketTimeoutException) {
                    ...
                    Toast.makeText(AlertActivity.this, "Unable to submit post to API.Connection timed out", Toast.LENGTH_LONG).show();
                }else{
