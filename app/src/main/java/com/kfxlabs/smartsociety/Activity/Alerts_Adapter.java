...
public class Alerts_Adapter extends RecyclerView.Adapter<Alerts_Adapter.ViewHolder>{

    Context context;
    List<Alerts_Details> alertValueDetailsList;

    public Alerts_Adapter(Context context, List<Alerts_Details> alerts_details){
