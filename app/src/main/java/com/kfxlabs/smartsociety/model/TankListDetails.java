...
public class TankListDetails {
    ...
    public TankListDetails(String tName, String tType, String tDevId, String tPIn, String tLocation, String tCapacity, String tDepth, String tOffset) {
        this.tankName = tName;
        this.tType = tType;
        this.tDevId = tDevId;
        this.tPin = tPIn;
