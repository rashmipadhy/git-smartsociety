...
public class DgListDetails implements Serializable {
    ...
    public DgListDetails(String dgName, String dgMake, String dgDevId, String dgpin, String dgLocation, String dgkva, String dgReading) {
        this.dgName = dgName;
        this.dgMake = dgMake;
